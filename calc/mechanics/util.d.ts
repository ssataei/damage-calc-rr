...
export declare function getMoveEffectiveness(gen: Generation, move: Move, type: TypeName, isGhostRevealed?: boolean, isGravity?: boolean, isRingTarget?: boolean, isBoneZone?: boolean, isCorrosion?: boolean, isInverse?: boolean): number;
