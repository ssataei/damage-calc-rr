...
var GSC_PATCH = {
    ...
    Qwilfish: {
        types: ['Water', 'Poison'],
        bs: { hp: 80, at: 95, df: 75, sa: 55, sd: 55, sp: 85 },
        weightkg: 3.9
    },
    Raikou: {
        types: ['Electric'],
...
var SV_PATCH = {
    ...
    'Dunsparce': { bs: { df: 80, sd: 75 }, nfe: true },
    ...
    'Talonflame': { bs: { at: 91 } },
    'Tauros': { bs: { sa: 70 }, otherFormes: ['Tauros-Paldea-Aqua', 'Tauros-Paldea-Blaze', 'Tauros-Paldea-Combat'] },
